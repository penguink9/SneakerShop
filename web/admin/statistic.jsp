...
<html>
    ...
    <body>
        ...
        <header>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between p-md-1">
                                            ...
                                            <div class="align-self-center">
                                                <h2 class="h1 mb-0">${numberProducts}</h2>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between p-md-1">
                                        <div class="d-flex flex-row">
                                            <div class="align-self-center">
                                                <h2 class="h1 mb-0 me-4">${String.format("%.1f",totalSales/1000000)} Triệu VNĐ</h2>
                                            </div>
                                            <div>
                                ...
                                <div class="card-body">
                                    <div class="d-flex justify-content-between p-md-1">
                                        <div class="d-flex flex-row">
                                            ...
                                            <div>
                                                <h4>Number of Sneakers Sold</h4>
                                                <p class="mb-0"></p>
                                            </div>
                                        </div>
                                        <div class="align-self-center">
                                            <h2 class="h1 mb-0">${numberSneakersSold}</h2>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between p-md-1">
                                            ...
                                            <div class="align-self-center">
                                                <h2 class="h1 mb-0">${numberUsers}</h2>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <section class="mb-4" id="tyLeChonHangGiay">
                <div class="card">
                    <div class="card-header py-3">
                        <h5 class="mb-0 text-center"><strong>Number Sneaker Sold By Category</strong></h5>
                    </div>
                    <div class="card-body">
        ...
        <script>// Graph
            //pie
            console.log(`Nike: ${numberNikeSold}, Adidas: ${numberAdidasSold}, Puma: ${numberPumaSold}, New Balance: ${numberNBSold}`);
            ...
            var myPieChart = new Chart(ctxP, {
                ...
                data: {
                    ...
                    datasets: [{
                            data: [${numberNikeSold}, ${numberAdidasSold}, ${numberPumaSold}, ${numberNBSold}],
